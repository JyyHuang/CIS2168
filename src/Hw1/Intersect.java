...
public class Intersect {
    public static void main(String[] args) {
        ArrayList<Integer> list1 = new ArrayList<>(List.of(1,4,8,9,11,15,17,28,41,59, 81));
        ArrayList<Integer> list2 = new ArrayList<>(List.of(4,7,11,17,19,20,23,28,37,59));
    ...
    public static ArrayList<Integer> intersect(ArrayList<Integer> list1, ArrayList<Integer> list2){
        // If list1 and list2 aren't sorted, this makes time complexity worse
        ...
        while (pList1 < list1.size() && pList2 < list2.size()){
            System.out.println(list2.get(pList2));
